...
device = 'cuda'
CKPTS = [
    ('/workspace/EnergyMatchingEqProp/results_mnist_pcn/stage_3_ep/EM_mnist_pcn_ep_20260713_15/checkpoint_5000.pt', 'step5k (healthy)'),
    ('/workspace/EnergyMatchingEqProp/results_mnist_pcn/stage_3_ep/EM_mnist_pcn_ep_20260713_15/checkpoint_10000.pt', 'step10k (post-blowup)'),
]
...
for ckpt_path, label in CKPTS:
    ...
    for seed in range(N_BATCHES):
        ...
        ut = torch.randn(128,1,28,28, device=device)
