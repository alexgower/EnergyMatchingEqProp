        ...
        for batch_idx, (data, _) in enumerate(train_loader):
            ...
            if (batch_idx + 1) % 10 == 0 or batch_idx == 0:
                ...
                batch_msg = (
                    ...
                    f"Loss={loss.item():.6f}, Flow={flow_loss_val.item():.6f}, "
                    f"Pos={pos_loss_val.item():.6f}, Neg={neg_loss_val.item():.6f}, "
                    f"RunAvg={avg_so_far:.6f}"
                )
                log_message(batch_msg, results_dir)
...
def main():
    ...
    parser.add_argument('--save_every', type=int, default=1,
                        help="Save samples/diagnostics/checkpoint every N epochs.")
